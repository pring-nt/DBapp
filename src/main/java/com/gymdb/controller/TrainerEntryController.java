...
public class TrainerEntryController {
    ...
    @FXML private TextField txtRecord;           // instructor record (text)
    @FXML private ComboBox<String> cmbType;      // Trainer / Staff
    @FXML private ComboBox<String> cmbSchedule;  // AM / PM
    @FXML private ComboBox<String> cmbSpeciality; // Yoga, Strength Training, HIIT, Zumba
    ...
    private void initialize() {
        ...
        cmbSchedule.getItems().addAll("AM", "PM");
        cmbSchedule.setValue("AM"); // optional default

        // Populate speciality options
        cmbSpeciality.getItems().addAll("Yoga", "Strength Training", "HIIT", "Zumba");
        cmbSpeciality.setValue("Yoga"); // optional default
    }
    ...
    private void handleSave(ActionEvent event) {
        ...
        String schedule = cmbSchedule.getValue() == null ? "" : cmbSchedule.getValue().trim();
        String record = txtRecord.getText() == null ? "" : txtRecord.getText().trim();
        String speciality = cmbSpeciality.getValue() == null ? "" : cmbSpeciality.getValue().trim();
        ...
        // Confirm before saving — message adjusts to selected personnel type
        Alert confirm = new Alert(Alert.AlertType.CONFIRMATION);
        confirm.setTitle("Confirm Add");
        confirm.setHeaderText(null);

        String noun = (type == null) ? "trainer" : type.toLowerCase();
        confirm.setContentText("Are you sure you want to add " + noun + "?");
    ...
    private void clearForm() {
        ...
        txtLastName.clear();
        txtRecord.clear();
        cmbSpeciality.setValue("Yoga"); // or set to null if you prefer empty
        cmbSchedule.setValue("AM");     // or set to null if you prefer empty
        cmbType.setValue("Trainer");
    }
